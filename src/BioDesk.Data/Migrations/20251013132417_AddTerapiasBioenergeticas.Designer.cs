...
namespace BioDesk.Data.Migrations
{
    ...
    [Migration("20251013132417_AddTerapiasBioenergeticas")]
    partial class AddTerapiasBioenergeticas
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("BioDesk.Domain.Entities.ConfiguracaoClinica", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            DataAtualizacao = new DateTime(2025, 10, 13, 13, 24, 15, 937, DateTimeKind.Utc).AddTicks(5218),
            ...
            modelBuilder.Entity("BioDesk.Domain.Entities.EventoHardware", b =>
                {
                    ...
                    b.Property<int?>("SessaoTerapiaId1")
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("BioDesk.Domain.Entities.Paciente", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            DataCriacao = new DateTime(2025, 9, 13, 13, 24, 15, 937, DateTimeKind.Utc).AddTicks(4362),
                        ...
                        {
                            Id = 2,
                            DataCriacao = new DateTime(2025, 9, 28, 13, 24, 15, 937, DateTimeKind.Utc).AddTicks(4375),
                        ...
                        {
                            Id = 3,
                            DataCriacao = new DateTime(2025, 10, 6, 13, 24, 15, 937, DateTimeKind.Utc).AddTicks(4379),
            ...
            modelBuilder.Entity("BioDesk.Domain.Entities.Sessao", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CriadoEm = new DateTime(2025, 9, 13, 14, 24, 15, 937, DateTimeKind.Local).AddTicks(5033),
                            DataHora = new DateTime(2025, 9, 13, 14, 24, 15, 937, DateTimeKind.Local).AddTicks(5021),
                            DuracaoMinutos = 60,
                            IsDeleted = false,
                        ...
                        new
                        {
                            ...
                            CriadoEm = new DateTime(2025, 9, 20, 14, 24, 15, 937, DateTimeKind.Local).AddTicks(5041),
                            DataHora = new DateTime(2025, 9, 20, 14, 24, 15, 937, DateTimeKind.Local).AddTicks(5038),
                            DuracaoMinutos = 45,
                            IsDeleted = false,
                        ...
                        new
                        {
                            ...
                            CriadoEm = new DateTime(2025, 10, 3, 14, 24, 15, 937, DateTimeKind.Local).AddTicks(5048),
                            DataHora = new DateTime(2025, 10, 3, 14, 24, 15, 937, DateTimeKind.Local).AddTicks(5045),
                            DuracaoMinutos = 60,
                            IsDeleted = false,
                        ...
                        new
                        {
                            ...
                            CriadoEm = new DateTime(2025, 9, 28, 14, 24, 15, 937, DateTimeKind.Local).AddTicks(5056),
                            DataHora = new DateTime(2025, 9, 28, 14, 24, 15, 937, DateTimeKind.Local).AddTicks(5052),
                            DuracaoMinutos = 90,
                            IsDeleted = false,
                        ...
                        new
                        {
                            ...
                            CriadoEm = new DateTime(2025, 10, 12, 14, 24, 15, 937, DateTimeKind.Local).AddTicks(5063),
                            DataHora = new DateTime(2025, 10, 12, 14, 24, 15, 937, DateTimeKind.Local).AddTicks(5060),
                            DuracaoMinutos = 60,
                            IsDeleted = false,
                        ...
                        new
                        {
                            ...
                            CriadoEm = new DateTime(2025, 10, 8, 14, 24, 15, 937, DateTimeKind.Local).AddTicks(5070),
                            DataHora = new DateTime(2025, 10, 8, 14, 24, 15, 937, DateTimeKind.Local).AddTicks(5066),
                            DuracaoMinutos = 120,
                            IsDeleted = false,
            ...
            modelBuilder.Entity("BioDesk.Domain.Entities.Terapia", b =>
                {
                    ...
                    b.Property<int?>("ProtocoloTerapeuticoId1")
                        .HasColumnType("INTEGER");
                    ...
                    b.HasIndex("ProtocoloTerapeuticoId1");
            ...
            modelBuilder.Entity("BioDesk.Domain.Entities.EventoHardware", b =>
                {
                    ...
                    b.HasOne("BioDesk.Domain.Entities.SessaoTerapia", null)
                        .WithMany("EventosHardware")
                        .HasForeignKey("SessaoTerapiaId1");
            ...
            modelBuilder.Entity("BioDesk.Domain.Entities.Terapia", b =>
                {
                    ...
                    b.HasOne("BioDesk.Domain.Entities.ProtocoloTerapeutico", null)
                        .WithMany("Terapias")
                        .HasForeignKey("ProtocoloTerapeuticoId1");
